  ...
  static const List<Map<String, dynamic>> changelogs = [
    {
      ...
      "v1.1.1": {
        ...
        "notes": [
          ...
          "LINUX - Adjusted UI for larger screens and window resizing",
          "LINUX - Added keyboard shortcuts for navigation and playback control",
          "LINUX - Added quality selection options in video player settings",
          "LINUX - Added subtitle choices in video player settings",
          "LINUX - Improved file system access for backups",
          "LINUX - Enhanced performance optimizations for desktop environments",
          "ANDROID & iOS - Enhanced video player with better buffering and error handling",
          "ANDROID & iOS - Added support for skipping intros and outros",
          "ANDROID & iOS - Added link sharing functionality for anime",
          "ANDROID & iOS - Added support for app to open supported links directly",
          "ANDROID & iOS - Added notification support when playing videos",
