...
class UpdateSettingsSheet extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<UpdateSettingsSheet> createState() => _UpdateSettingsSheetState();
}
...
class _UpdateSettingsSheetState extends ConsumerState<UpdateSettingsSheet> {
                ...
                children: [
                  ...
                  SliderTheme(
                    data: SliderTheme.of(context).copyWith(
                      ...
                      inactiveTrackColor: AppTheme.gradient1.withValues(alpha: 0.3),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    Icon(Icons.info_outline, color: AppTheme.gradient1, size: 16),
                    SizedBox(width: 8),
                    Expanded(
                      child: Text(
                        lastCheckText,
  ...
  void _checkForUpdatesNow() async {
    ...
    try {
      final success = await ref.read(updateSettingsProvider.notifier).checkForUpdatesNow();
  ...
  void _saveSettings() async {
    await ref.read(updateSettingsProvider.notifier).setAutoCheckEnabled(_autoCheckEnabled);
    await ref.read(updateSettingsProvider.notifier).setCheckInterval(_checkInterval.toInt());
